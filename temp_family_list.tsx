...
export default function FamilyListScreen() {
  ...
  const families = allFamilies.map(f => ({
    ...
    name: f.name,
    image: null,
    lastMessage: 'Bß║Ñm ─æß╗â bß║»t ─æß║ºu tr├▓ chuyß╗çn',
  }));
  ...
  if (families.length === 0) {
    return (
      <View style={[styles.emptyState, { paddingTop: insets.top }]}>
        ...
        <Text style={styles.emptyText}>Bß║ín ch╞░a thuß╗Öc gia ─æ├¼nh n├áo.</Text>
        <Text style={styles.emptySubText}>
          V├áo tab Gia ─æ├¼nh ─æß╗â tß║ío hoß║╖c tham gia mß╗Öt tß╗ò ß║Ñm nh├⌐!
        </Text>
      </View>
    );
  }
