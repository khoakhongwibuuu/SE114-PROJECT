...
export default function HealthProfileDetailScreen() {
  ...
  const statusLabel = member?.healthStatus || 'Sß╗⌐c khß╗Åe tß╗æt';
  ...
  return (
    <View style={styles.root}>
      <TopAppBar variant="detail" title={member?.fullName || 'Chi tiß║┐t hß╗ô s╞í'} />
      <ScrollView
      ...
      >
        <View style={styles.heroSection}>
          <Avatar name={member?.fullName || 'Th├ánh vi├¬n'} size="xl" />
          <Text style={styles.heroName}>{member?.fullName || '─Éang tß║úi...'}</Text>
        ...
        <View style={[styles.card, shadows.sm]}>
          <Text style={styles.cardTitle}>Th├┤ng tin c╞í bß║ún</Text>
          <View style={styles.infoGrid}>
            <View style={styles.infoItem}>
              <Icon name="healing" size={16} color={colors.primary} />
              <View>
                <Text style={styles.infoLabel}>Nh├│m m├íu</Text>
            ...
            <View style={styles.infoItem}>
              ...
              <View>
                <Text style={styles.infoLabel}>Ng├áy sinh</Text>
            ...
            <View style={styles.infoItem}>
              ...
              <View>
                <Text style={styles.infoLabel}>Giß╗¢i t├¡nh</Text>
            ...
            <View style={styles.infoItem}>
              ...
              <View>
                <Text style={styles.infoLabel}>Chiß╗üu cao / C├ón nß║╖ng</Text>
        ...
        <View style={[styles.card, shadows.sm]}>
          <Text style={styles.cardTitle}>Tiß╗ün sß╗¡ bß╗çnh</Text>
          {member?.medicalHistory ? (
            <View style={styles.historyItem}>
              <View style={styles.historyDot} />
              <View style={styles.historyContent}>
                <Text style={styles.historyName}>Ghi ch├║ bß╗çnh l├╜</Text>
                <Text style={styles.historyDesc}>{member.medicalHistory}</Text>
              </View>
            </View>
          ) : (
            <Text style={styles.emptyText}>Ch╞░a c├│ th├┤ng tin</Text>
          )}
        </View>

        <View style={[styles.card, shadows.sm]}>
          <Text style={styles.cardTitle}>Dß╗ï ß╗⌐ng</Text>
          <View style={styles.chipRow}>
            {member?.allergy ? (
              ...
              <Text style={styles.emptyText}>Kh├┤ng c├│ dß╗ï ß╗⌐ng</Text>
            )}
          </View>
        </View>

        <View style={[styles.card, shadows.sm]}>
          <Text style={styles.cardTitle}>Th├┤ng tin bß╗ò sung</Text>
          <View style={styles.infoBox}>
            <Icon name="info" size={32} color={colors.onSurfaceVariant} />
            <Text style={styles.infoHint}>
              Hß╗ô s╞í ─æang hiß╗ân thß╗ï dß╗» liß╗çu sß╗⌐c khß╗Åe thß║¡t tß╗½ backend.
            </Text>
          </View>
        </View>
        ...
        <View style={styles.actionRow}>
          ...
          >
            ...
            <Text style={styles.actionBtnPrimaryText}>Lß╗ïch ti├¬m chß╗ºng</Text>
          </TouchableOpacity>
          <TouchableOpacity
          ...
          >
            ...
            <Text style={styles.actionBtnSecondaryText}>Theo d├╡i ph├ít triß╗ân</Text>
          </TouchableOpacity>
        </View>
      </ScrollView>
    </View>
