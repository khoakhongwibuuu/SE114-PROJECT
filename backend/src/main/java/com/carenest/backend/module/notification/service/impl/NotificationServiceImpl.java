...
public class NotificationServiceImpl implements NotificationService {
    ...
    public org.springframework.data.domain.Page<com.carenest.backend.module.notification.dto.response.NotificationResponse> getUserNotifications(Long userId, NotificationType type, org.springframework.data.domain.Pageable pageable) {
        ...
        return page.map(notification -> com.carenest.backend.module.notification.dto.response.NotificationResponse.builder()
    ...
    @Override
    @Transactional
    public com.carenest.backend.module.notification.dto.response.NotificationResponse markAsRead(Long notificationId, Long userId) {
        Notification notification = notificationRepository.findById(notificationId)
                .orElseThrow(() -> new com.carenest.backend.common.exception.ResourceNotFoundException("Notification", "id", notificationId.toString()));
        ...
        return com.carenest.backend.module.notification.dto.response.NotificationResponse.builder()
                .id(saved.getId())
    ...
    @Override
    @Transactional(readOnly = true)
    public com.carenest.backend.module.notification.dto.response.UnreadCountResponse getUnreadCount(Long userId) {
        long count = notificationRepository.countUnreadNotifications(userId);
        return new com.carenest.backend.module.notification.dto.response.UnreadCountResponse(count);
    }
}
