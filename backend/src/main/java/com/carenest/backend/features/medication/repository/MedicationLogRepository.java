package com.carenest.backend.features.medication.repository;
...
public interface MedicationLogRepository extends JpaRepository<MedicationLog, Long> {
    ...
    List<MedicationLog> findAllByStatusAndIsNotifiedFalseAndScheduledTimeBetween(com.carenest.backend.features.medication.enums.MedicationLogStatus status, Instant start, Instant end);
    ...
    List<MedicationLog> findPendingTasksForFamilyToday(
            ...
            @Param("status") com.carenest.backend.features.medication.enums.MedicationLogStatus status,
