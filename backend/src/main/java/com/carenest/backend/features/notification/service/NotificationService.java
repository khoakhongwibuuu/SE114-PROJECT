package com.carenest.backend.features.notification.service;
...
public interface NotificationService {
    ...
    Page<com.carenest.backend.features.notification.dto.response.NotificationResponse> getUserNotifications(Long userId, NotificationType type, Pageable pageable);
